...
{
	MUSIC_TUNE_NONE = -1,
	MUSIC_TUNE_DAY_GRASSWALK = 1,				// Daytime grass level
	MUSIC_TUNE_NIGHT_MOONGRAINS,				// Dark grass level
	MUSIC_TUNE_POOL_WATERYGRAVES,				// Daytime pool level
	MUSIC_TUNE_FOG_RIGORMORMIST,				// Dark pool level
	MUSIC_TUNE_ROOF_GRAZETHEROOF,				// rooftop level
	MUSIC_TUNE_CHOOSE_YOUR_SEEDS,				// Card selection interface/mini game interface
	MUSIC_TUNE_TITLE_CRAZY_DAVE_MAIN_THEME,		// main menu
	MUSIC_TUNE_ZEN_GARDEN,						// Zen Garden
	MUSIC_TUNE_PUZZLE_CEREBRAWL,				// Puzzle mode
	MUSIC_TUNE_MINIGAME_LOONBOON,				// Games
	MUSIC_TUNE_CONVEYER,						// conveyor belt level
	MUSIC_TUNE_FINAL_BOSS_BRAINIAC_MANIAC,		// Dr. Zomboss's level
